CREATE PROCEDURE [dbo].[sproc_UnreadCommentsSummary_Get]
    @EntrepreneurId         bigint
AS
    SELECT  c.CompanyId, count(1) as UnreadCommentsCount
    FROM    AttributeQuestion aq 
            INNER JOIN  CompanyAttribute ca         ON aq.CompanyAttributeId = ca.Id
